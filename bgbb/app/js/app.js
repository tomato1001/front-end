...
_react2['default'].render(_react2['default'].createElement(_componentsAppContainer2['default'], null), document.getElementById('container'));

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./components/AppContainer":162,"pace":1,"react":159}],162:[function(require,module,exports){
'use strict';
...
var _AppSidebarCollapse = require('./AppSidebarCollapse');

var _AppSidebarCollapse2 = _interopRequireDefault(_AppSidebarCollapse);
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					_NavHeader2['default'],
					null,
					_react2['default'].createElement(_AppSidebarCollapse2['default'], null)
				),
				_react2['default'].createElement(
					'div',
					{ className: 'app-content' },
					_react2['default'].createElement(_AppSidebar2['default'], null),
					_react2['default'].createElement('div', { className: 'app-body' })
				)
			);
		}
	}]);
...
},{"./AppSidebar":163,"./AppSidebarCollapse":164,"./NavHeader":165,"react":159}],163:[function(require,module,exports){
'use strict';
...
var AppSidebar = (function (_React$Component) {
	function AppSidebar(props) {
		...
		_get(Object.getPrototypeOf(AppSidebar.prototype), 'constructor', this).call(this, props);
		this.state = {
			curIndex: '',
			open: false,
			activeIndex: ''
	...
	_createClass(AppSidebar, [{
		key: 'setCurrentIndex',
		value: function setCurrentIndex(idx, open, active) {
			var data = {
				curIndex: idx,
				open: open
			};
		...
		value: function render() {
			...
			var curItemData = _underscore2['default'].extend({}, this.state);
			return _react2['default'].createElement(
				'div',
				{ className: 'app-sidebar' },
				_react2['default'].createElement(Menu, { curItemData: curItemData,
					data: data,
					isChild: false,
					setIndexHandler: function (idx, open, active) {
						return _this.setCurrentIndex(idx, open, active);
					},
					idxPrefix: '0' })
			);
		}
...
var Menu = (function (_React$Component2) {
	...
	_createClass(Menu, [{
		key: 'handleItemClick',
		value: function handleItemClick(item, idx, hasChild) {
			var curItemData = this.props.curItemData;
			var open = false;
			if (!item.href) {
				// todo:
				var index = idx;
		...
		key: 'computeLiClass',
		value: function computeLiClass(item, idx) {
		...
		key: 'computeNode',
		value: function computeNode(data) {
			var _this2 = this;

			var node = [],
			    curItemData = this.props.curItemData,
			    setIndexHandler = this.props.setIndexHandler,
			    onItemClick = function onItemClick(text, idx, hasChild) {
				return _this2.handleItemClick(text, idx, hasChild);
			},
			    itemCls = function itemCls(item, idx) {
				return _this2.computeLiClass(item, idx);
			};

			data.forEach(function (item, index) {
				var idx = _this2.computeIdx(index);
				if (item.children && item.children.length > 0) {
					node.push(_react2['default'].createElement(
						...
						{ item: item,
							...
							idx: idx },
						_react2['default'].createElement(Menu, { data: item.children,
					...
					node.push(_react2['default'].createElement(SubMenu, { item: item,
						key: idx,
						onItemClick: onItemClick,
						itemCls: itemCls(item, idx),
						idx: idx }));
		...
		key: 'computeIdx',
		value: function computeIdx(index) {
		...
		value: function render() {
			var data = this.props.data,
			    ...
			    cls = (0, _classnames2['default'])('nav', { 'sidebar-menu': !isChild }, { submenu: isChild });
			return _react2['default'].createElement(
				'ul',
				{ className: cls },
...
var SubMenu = (function (_React$Component3) {
	function SubMenu() {
		_classCallCheck(this, SubMenu);

		_get(Object.getPrototypeOf(SubMenu.prototype), 'constructor', this).apply(this, arguments);
	}

	_inherits(SubMenu, _React$Component3);
	...
	_createClass(SubMenu, [{
		...
		value: function render() {
			...
			var item = this.props.item,
			    hasChild = _react2['default'].Children.count(this.props.children),
			    iconCls = (0, _classnames2['default'])('menu-icon', 'fa', item.icon),
			    liCls = this.props.itemCls,
			    expandEl = hasChild ? _react2['default'].createElement('i', { className: (0, _classnames2['default'])({ 'fa fa-angle-right expand': hasChild }) }) : null;
			return _react2['default'].createElement(
				'li',
				{ className: liCls },
				_react2['default'].createElement(
					'a',
					{ href: item.href, onClick: function () {
							return _this3.props.onItemClick(item, _this3.props.idx, hasChild);
						} },
...
},{"classnames":3,"jquery":4,"react":159,"underscore":160}],164:[function(require,module,exports){
'use strict';
...
var AppSidebarCollapse = (function (_React$Component) {
	function AppSidebarCollapse(props) {
		_classCallCheck(this, AppSidebarCollapse);

		_get(Object.getPrototypeOf(AppSidebarCollapse.prototype), 'constructor', this).call(this, props);
		this.state = {
			active: this.props.active
		};
	}

	_inherits(AppSidebarCollapse, _React$Component);

	_createClass(AppSidebarCollapse, [{
		key: 'toggleActive',
		...
		value: function render() {
			...
			var activeCls = (0, _classnames2['default'])('app-sidebar-collapse', { active: this.state.active });
			return _react2['default'].createElement(
				'div',
				{ className: activeCls, onClick: function () {
						return _this.toggleActive();
					} },
				_react2['default'].createElement(
					'div',
					{ className: 'app-sidebar-collapse-icon' },
...
exports['default'] = AppSidebarCollapse;
module.exports = exports['default'];

},{"classnames":3,"react":159}],165:[function(require,module,exports){
"use strict";
...
var NavHeader = (function (_React$Component) {
	function NavHeader() {
		...
		_get(Object.getPrototypeOf(NavHeader.prototype), "constructor", this).apply(this, arguments);
	}
