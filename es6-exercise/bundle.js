...
/***/ function(module, exports, __webpack_require__) {
	...
	var indentStr = function indentStr(num, showSymbol) {
	    ...
	    var sbl = showSymbol ? "✔" : "";
	    (_console = console).log.apply(_console, [prefix + " " + sbl].concat(rest));
	};

	var indentWithoutSymbol = function indentWithoutSymbol(num) {
	    for (var _len2 = arguments.length, rest = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
	        rest[_key2 - 1] = arguments[_key2];
	    }

	    return indentStr.apply(undefined, [num, false].concat(rest));
	};

	var indentWithSymbol = function indentWithSymbol(num) {
	    for (var _len3 = arguments.length, rest = Array(_len3 > 1 ? _len3 - 1 : 0), _key3 = 1; _key3 < _len3; _key3++) {
	        rest[_key3 - 1] = arguments[_key3];
	    }

	    return indentStr.apply(undefined, [num, true].concat(rest));
	};
	...
	ids.forEach(function (v, idx, arr) {
	...
	var name = obj.name;
	var age = obj.age; // object matching

	indentWithSymbol(2, "map");
	indentWithoutSymbol(3, name, age);

	indentWithSymbol(2, "map with default value");
	var _obj$desc = obj.desc;
	var desc = _obj$desc === undefined ? "default desc" : _obj$desc;

	indentWithoutSymbol(3, desc);

	indentWithSymbol(2, "array");
	var _ids$ = ids[0];
	var id1 = _ids$ === undefined ? 33 : _ids$;
	var id2 = ids[1];
	var rest = ids.slice(2);
	...
	var res = Array.from(arr, function (x) {
	    return x + x;
	});
	indentWithoutSymbol(2, res);
